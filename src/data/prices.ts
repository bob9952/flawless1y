...
export const priceGroups: PriceGroup[] = [
  {
    ...
    items: [
      ...
      { name: "Trosed — standardni", price: "2.600 RSD" },
      { name: "Trosed na izvlačenje", price: "3.400 RSD" },
      { name: "Dvosed — standardni", price: "2.200 RSD" },
      { name: "Dvosed na izvlačenje", price: "2.650 RSD" },
      { name: "Garnitura — po sednom mestu", price: "1.000 RSD" },
      { name: "Tabure — mali", price: "550 RSD" },
      { name: "Tabure — veliki", price: "950 RSD" },
